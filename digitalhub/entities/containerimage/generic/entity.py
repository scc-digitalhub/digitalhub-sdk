...
class ContainerimageGeneric(ContextEntity, VersionedMixin, GenericMixin):
    """Generic container image entity that preserves runtime fields without container-image specific methods."""
