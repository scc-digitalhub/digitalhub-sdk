...
class FunctionGenericBuilder(GenericBuilder, FunctionBuilder):
    """Builder for generic functions that preserves arbitrary payload fields."""

    ENTITY_TYPE = EntityTypes.FUNCTION.value
    ENTITY_CLASS = FunctionGeneric
