...
@pytest.mark.parametrize(
    ...
    [
        ("register_artifact", "artifact", "register_artifact", {}),
        ...
        ("register_table", "dataitem", "register_table", {}),
        ...
        ("register_mlflow", "model", "register_mlflow", {}),
        ("register_huggingface", "model", "register_huggingface", {}),
        ("register_sklearn", "model", "register_sklearn", {}),
        ("register_tvm_ir", "model", "register_tvm_ir", {}),
        ("register_tvm_so", "model", "register_tvm_so", {}),
    ],
)
